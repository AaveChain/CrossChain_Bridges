const logger = fireblocks.Cloud.getLogger();

const web3Main = fireblocks.web3ByChain("0x4"); // Rinkeby Testnet
const web3Side = fireblocks.web3ByChain("0x13881"); // Mumbai Testnet
...
fireblocks.Cloud.afterSave("EthTokenTransfers", (request) => {
...
fireblocks.Cloud.afterSave("PolygonTokenTransfers", (request) => {
    const data = JSON.parse(JSON.stringify(request.object, ["token_address", "to_address", "from_address","transaction_hash","value", "confirmed"]));
    logger.info(data);
